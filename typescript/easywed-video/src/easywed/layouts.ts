...
export const WIDE_HALL = withDerived({
  ...
  tables: [
    { id: "head", label: "Stół pary młodej", shape: "rect", x: 660, y: 120, width: 360, height: 84, seats: 10 },
    { id: "t1", label: "Stół 1", shape: "round", x: 200, y: 330, width: 140, height: 140, seats: 8 },
    { id: "t2", label: "Stół 2", shape: "round", x: 200, y: 570, width: 140, height: 140, seats: 8 },
    { id: "t3", label: "Stół 3", shape: "round", x: 1120, y: 330, width: 140, height: 140, seats: 8 },
    { id: "t4", label: "Stół 4", shape: "round", x: 1120, y: 570, width: 140, height: 140, seats: 8 },
    { id: "t5", label: "Stół 5", shape: "round", x: 490, y: 690, width: 140, height: 140, seats: 8 },
    { id: "t6", label: "Stół 6", shape: "round", x: 830, y: 690, width: 140, height: 140, seats: 8 },
  ],
  fixtures: [
    { id: "bar", label: "Bar", x: 200, y: 780, width: 200, height: 56 },
    { id: "cake", label: "Stół z tortem", x: 1120, y: 780, width: 200, height: 56 },
  ],
});
...
export const TALL_HALL = withDerived({
  ...
  tables: [
    { id: "head", label: "Stół pary młodej", shape: "rect", x: 420, y: 110, width: 320, height: 80, seats: 10 },
    { id: "t1", label: "Stół 1", shape: "round", x: 120, y: 330, width: 130, height: 130, seats: 8 },
    { id: "t2", label: "Stół 2", shape: "round", x: 720, y: 330, width: 130, height: 130, seats: 8 },
    { id: "t3", label: "Stół 3", shape: "round", x: 120, y: 560, width: 130, height: 130, seats: 8 },
    { id: "t4", label: "Stół 4", shape: "round", x: 720, y: 560, width: 130, height: 130, seats: 8 },
    { id: "t5", label: "Stół 5", shape: "round", x: 250, y: 800, width: 130, height: 130, seats: 8 },
    { id: "t6", label: "Stół 6", shape: "round", x: 590, y: 800, width: 130, height: 130, seats: 8 },
  ],
