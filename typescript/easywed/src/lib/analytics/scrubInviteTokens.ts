...
// descended into: rrweb nests recorded hrefs far deeper than MAX_DEPTH, and
// walking those payloads on every snapshot would be real overhead. **Replay is
// therefore not covered.** If it is enabled on the project, /invite/* needs
// excluding in the PostHog session-recording settings, or the token needs moving
