  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-6 z-50 flex justify-center print:hidden">
      <div
        ...
        className={cn(
          "flex items-center gap-3 rounded-full border border-planner-table-border bg-planner-soft/90 px-4 py-2 text-xs text-planner-selected shadow-md backdrop-blur-sm transition-opacity",
          faded
      ...
      >
        ...
        <span className="flex items-center gap-1.5">
          <kbd className="rounded border border-planner-table-border bg-background px-1.5 py-0.5 font-mono text-[10px]">
            Esc
          </kbd>
          <span className="text-planner-selected/80">
            {t("statusbar.esc_to_exit")}
          </span>
        </span>
      </div>
    </div>
