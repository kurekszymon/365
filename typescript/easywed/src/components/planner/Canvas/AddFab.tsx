...
export const AddFab = () => {
  ...
  return (
    <button
      ...
      className="absolute right-4 bottom-24 z-20 flex size-14 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-[0_14px_28px_-10px_var(--color-primary)]"
    >
